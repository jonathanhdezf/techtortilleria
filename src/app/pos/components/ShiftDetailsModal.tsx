        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
                ...
                <motion.div
                    ...
                    className="relative bg-secondary/80 border border-white/5 rounded-[3.5rem] p-8 md:p-14 max-w-4xl w-full shadow-3xl backdrop-blur-3xl overflow-hidden flex flex-col max-h-[90vh]"
                >
