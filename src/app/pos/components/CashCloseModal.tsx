        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
                ...
                <motion.div
                    ...
                    className="relative bg-secondary/80 border border-white/5 rounded-[3.5rem] p-10 md:p-14 max-w-2xl w-full shadow-3xl backdrop-blur-3xl overflow-hidden"
                >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                            ...
                            <div className="bg-white/5 border border-white/5 rounded-[2.5rem] p-8">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <span className="text-[10px] font-black text-white/40 uppercase tracking-widest">Resumen de Ventas</span>
                                </div>
                                <div className="space-y-4">
                                    <div className="flex justify-between items-center px-2">
                                        <span className="text-xs font-bold text-white/20 uppercase tracking-widest">Total en Caja</span>
                                        <span className="text-xl font-black text-white tabular-nums">$0.00</span>
                                    </div>
                                    <div className="h-px bg-white/5 w-full" />
                                    <div className="flex justify-between items-center px-2">
                                        <span className="text-xs font-bold text-white/20 uppercase tracking-widest">Ventas Efectivo</span>
                                        <span className="text-xl font-black text-emerald-400 tabular-nums">$0.00</span>
                                    </div>
                                    <div className="flex justify-between items-center px-2">
                                        <span className="text-xs font-bold text-white/20 uppercase tracking-widest">Ventas Tarjeta</span>
                                        <span className="text-xl font-black text-primary tabular-nums">$0.00</span>
                                    </div>
                                </div>
                            </div>
