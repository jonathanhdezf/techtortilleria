...
import { X, Zap, DollarSign, FileText, AlertCircle, ArrowUpCircle } from 'lucide-react'
...
export default function ExpenseModal({ isOpen, onClose }: ExpenseModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await createExpenseAction(val, description)
            setSuccess(true)
            setTimeout(() => {
                setSuccess(false)
                setAmount('')
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            <div className="flex justify-between items-center mb-6">
                                <div>
                                    <p className="text-[9px] font-black text-red-400 uppercase tracking-[0.4em] mb-1.5">Gasto Operativo</p>
                                    <h2 className="text-xl md:text-3xl font-black text-white italic uppercase tracking-tighter">Registrar <span className="text-red-400">Salida</span></h2>
                                </div>
                                <button
                                    onClick={onClose}
                                    title="Cerrar modal"
                                ...
                                {!success ? (
                                    ...
                                    >
                                        <div className="space-y-5">
                                            <div>
                                                ...
                                                <div className="relative">
                                                    <div className="absolute left-6 top-1/2 -translate-y-1/2 text-red-400 font-black text-2xl italic pointer-events-none">$</div>
                                                    <input
                                                        type="number"
                                                        step="0.01"
                                                        required
                                                        ...
                                                        className="block w-full pl-12 pr-6 py-6 bg-white/5 border border-white/5 rounded-[1.8rem] font-black text-3xl tabular-nums text-white placeholder-white/5 focus:outline-none focus:bg-white/10 focus:border-red-500/30 transition-all font-mono"
                                                        placeholder="0.00"
                                                        title="Ingresa el monto del gasto"
                                                    />
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <textarea
                                                        ...
                                                        placeholder="EJ: PAGO DE LUZ, COMPRA INSUMOS..."
                                                        title="Ingresa el concepto del gasto"
                                                    />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <button
                                            ...
                                            className="w-full py-6 bg-red-500 text-secondary rounded-[1.8rem] font-black text-base uppercase tracking-widest shadow-2xl shadow-red-500/20 hover:bg-red-600 hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-3 disabled:grayscale disabled:opacity-50"
                                        >
                                            {loading ? (
                                    ...
                                    >
                                        ...
                                        <p className="text-[9px] font-black text-white/40 uppercase tracking-[0.4em]">Gasto registrado correctamente</p>
                                    </motion.div>
                                )}
                            </AnimatePresence>
